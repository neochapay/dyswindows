...
#ifndef Y_CPP_YTOGGLEBUTTON_H
#define Y_CPP_YTOGGLEBUTTON_H

#include <Y/c++/connection.h>
#include <Y/c++/widget.h>

#include <Y/c++/YToggleButton.yh>
...
namespace Y
{
   ...
   * \ingroup remote
   */
  class YToggleButton : public Y::ServerObject::YToggleButton
  {
  public:
    YToggleButton (Y::Connection *y);
    ...
    sigc::signal<void> buttonPressed;
    sigc::signal<void> buttonReleased;
